...
import com.Jorge.Aneury.practica4.servicios.JwtService;
import com.Jorge.Aneury.practica4.servicios.MockupService;
...
public class MockupController {
    ...
    @GetMapping("test/{id}")
    public ResponseEntity<String> test(@PathVariable UUID id, Model model, HttpServletRequest request) {
        Mockup mockup = mockupService.getMockupById(id);
        ...
        return new RestTemplate().exchange(fullUrl, httpMethod, entity, String.class);
    }
